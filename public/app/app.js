...
angular.module('myApp', ['ngRoute', 'ngCookies', 'ui.bootstrap', 'ui.bootstrap.datetimepicker',
	...
	.config(['$routeProvider', function ($routeProvider) {
		$routeProvider
			...
			.when('/telefone/',			 { templateUrl: 'views/telefone/list.html',   controller: 'ListTelefoneController' })
			.when('/telefone/select',	 { templateUrl: 'views/telefone/select.html', controller: 'SelectTelefoneController' })
			.when('/telefone/add',        { templateUrl: 'views/telefone/edit.html',   controller: 'EditTelefoneController' })
			.when('/telefone/edit/:id', 	 { templateUrl: 'views/telefone/edit.html',   controller: 'EditTelefoneController' })
			.when('/telefone/delete/:id', { templateUrl: 'views/telefone/edit.html', 	 controller: 'EditTelefoneController' })
			.when('/telefone/view/:id', 	 { templateUrl: 'views/telefone/edit.html', 	 controller: 'EditTelefoneController' })

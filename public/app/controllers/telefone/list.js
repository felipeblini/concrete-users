angular.module('myApp').controller('ListTelefoneController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'TelefoneService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, TelefoneService) {
	...
	$scope.edit = function (obj) {
		$location.path('/telefone/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/telefone/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/telefone/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(TelefoneService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(TelefoneService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			TelefoneService, "telefones", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------

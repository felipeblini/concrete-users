...
var propertiesForClass = {
	"user" : ['userId', 'nome', 'email', 'senha', 'data_criacao', 'data_atualizacao', 'ultimo_login'],
	"telefone" : ['ddd', 'numero']  
};
...
buildModelAndControllerForSchema(models, 'telefone', 'telefones', TelefoneSchema);
